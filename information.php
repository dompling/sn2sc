...
if ($info['ismember'] == 1 && $info['userid']) {
    ...
    if ($member['userid'] && $group['member_contact'] == 0 && $info['ismember'] == '1') {
        $info['contact_who'] = $mymps_global['SiteContact'];
...
if ($info['is_replace'] == 1) {
    $info['contact_who'] = $info['r_contact_who'] ? $info['r_contact_who'] : $mymps_global['SiteContact'];
    $info['tel'] = $info['r_tel'] ? $info['r_tel'] : $mymps_global['SiteTel'];
    $info['qq'] = $info['r_qq'] ? $info['r_qq'] : $mymps_global['SiteQQ'];
    $info['email'] = $info['r_email'] ? $info['r_email'] : $mymps_global['SiteEmail'];
}
