# Identify: MTU0MjYxMzYyNiw1LjhFIFVURi04LG15bXBzLCwx
# <?exit();?>
# Mymps Multi-Volume Data Dump Vol.1
# Version: Mymps 5.8E UTF-8
# Time: 2018-11-19 15:47:06
# Type: mymps
# Table Prefix: my_
#
...
CREATE TABLE my_admin_record_action (
  ...
  PRIMARY KEY (id)
) ENGINE=MyISAM AUTO_INCREMENT=346 DEFAULT CHARSET=utf8 AUTO_INCREMENT=346;
...
) ENGINE=MyISAM AUTO_INCREMENT=217 DEFAULT CHARSET=utf8 AUTO_INCREMENT=217;
...
INSERT INTO my_config VALUES ('latestbackup','1540806729','database');
...
INSERT INTO my_mobile_nav VALUES ('41','新能源车','index.php?mod=category&catid=194','','/template/default/images/index/icon_che.gif','','_self','2','9','0','2');
