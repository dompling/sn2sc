# Identify: MTUzOTA3ODU0NSw1LjhFIFVURi04LG15bXBzLCwx
# <?exit();?>
# Mymps Multi-Volume Data Dump Vol.1
# Version: Mymps 5.8E UTF-8
# Time: 2018-10-09 17:49:05
# Type: mymps
# Table Prefix: my_
#
...
INSERT INTO my_admin VALUES ('1','admin','21232f297a57a5a743894a0e4a801fc3','admin','','121876673@qq.com','1','1539078054','112.18.110.95');
...
CREATE TABLE my_admin_record_action (
  ...
  PRIMARY KEY (id)
) ENGINE=MyISAM AUTO_INCREMENT=188 DEFAULT CHARSET=utf8 AUTO_INCREMENT=188;
...
INSERT INTO my_config VALUES ('latestbackup','1539077273','database');
...
INSERT INTO my_information VALUES ('1','比亚迪 M6 2013款 2.0L 手动舒适型','2','28','二手轿车','1','1538983725','0','0','基本信息&nbsp;<br />\r\n上牌时间&nbsp;2015年2月&nbsp;<br />\r\n表显里程&nbsp;6.2万公里&nbsp;<br />\r\n本车排量&nbsp;2.0L&nbsp;<br />\r\n变速箱&nbsp;手动&nbsp;<br />\r\n排放标准&nbsp;国Ⅳ&nbsp;<br />\r\n车辆性质&nbsp;正常家用&nbsp;<br />\r\n车辆颜色&nbsp;紫&nbsp;<br />\r\n维修保养&nbsp;非4S店维修保养&nbsp;<br />\r\n年检到期&nbsp;车主未填写&nbsp;<br />\r\n商业险到期&nbsp;车主未填写&nbsp;<br />\r\n交强险到期&nbsp;车主未填写&nbsp;<br />\r\n配置信息&nbsp;<br />\r\n档位个数&nbsp;5&nbsp;<br />\r\n驱动方式&nbsp;前置前驱&nbsp;<br />\r\n综合油耗&nbsp;8.9升/100公里&nbsp;<br />\r\n车身结构&nbsp;5门7座&nbsp;<br />\r\n发动机缸数&nbsp;4&nbsp;<br />\r\n最大功率&nbsp;103.0kW&nbsp;<br />\r\n进气类型&nbsp;自然吸气&nbsp;<br />\r\n查看参数配置&nbsp;<br />\r\n亮点配置&nbsp;<br />\r\n无钥匙启动&nbsp;<br />\r\n外接音源&nbsp;<br />\r\n后排出风口&nbsp;<br />\r\n自动空调&nbsp;<br />\r\n车辆描述&nbsp;<br />\r\n车主萍小姐说：&nbsp;<br />\r\n&nbsp;<br />\r\n标准7座MPV，车况好，双燃料，费用低，拉货拉人爽得很，车面有小剐蹭，但是整体车况很好;想要看车的朋友，随时联系;确定购买后，必须将车过户到您的名下;','','吉老师','','','13500000000','0','7','0','25d687e2c7e715b2f1c9bc30a47b0863','112.18.110.95','四川省移动','1','/attachment/information/201810/pre_1538983725uorth.png','1','1','0','1','0','1','0','0','jiaoche','','2','1539070412','','','0.00000000000000000','0.00000000000000000');
