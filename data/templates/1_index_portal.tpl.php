...
<div class="focushead_right">
                ...
                <div class="focuscorp">
                    <div class="focustop">
                        ...
                        <div class="wnum auto">
                        <a href="<?=$k['url']?>" class="sel" rel="nofollow"><img  src="<?=$k['image']?>" alt="<?=$k['words']?>" data-color=""/></a>                        </div>
                        </li>
                        <?php }} ?>
                        </ul>
                        <div class="wnum auto">
...
<div class="rollBox">
                ...
                <div class="Cont" id="ISL_Cont">
                    <div class="ScrCont">
                        ...
                        <span class="seecourse"><a href="<?=$k['uri']?>" target="_blank" class="red">查看店铺</a></span>                        </div>
                        <?php }} ?>
                        </div>
                        <div id="List2"></div>
                    </div>
        ...
        <div class="house">
            ...
            <div class="ershoufang">
                <div class="hd">
                    <div class="span">4S店新车</div>
                    <div class="more"><a href="<?=$portaluri['morezufang']?>" target="_blank">更多</a></div>
                </div>
                <div class="bd">
                    <ul>
                        <?php if(is_array($czf)){foreach($czf as $mymps) { ?>                        <li>
                            <div class="title"><a href="<?=$mymps['uri']?>" title="<?=$mymps['title']?>" target="_blank"><? echo cutstr($mymps['title'],24); ?></a></div>
                        </li>
                        <?php }} ?>
                    </ul>
                </div>
        ...
        <?php if(ifplugin('goods')){$goods = mymps_get_goods($tpl_index['goods'],1); ?><div class="clear5"></div>
<?php } ?>
