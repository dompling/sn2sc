    ...
    <div class="filter2" id="filter2">
        ...
        <div class="inner" style="display:none;">
            <ul>
                ...
                <?php if(is_array($area_list)){foreach($area_list as $k => $mymps) { ?>                <a class="<? echo $mymps['areaid'] == $areaid ? 'selected' : '';; ?>" href="index.php?mod=corp&catid=<?=$catid?>&areaid=<?=$mymps['areaid']?>"><?=$mymps['areaname']?></a>
                <?php }} ?>
            </ul>
        </div>
