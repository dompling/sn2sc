<?php include mymps_tpl('inc_head'); ?>
    ...
    <style>
        ...
        .checked {
            border: 2px #FFB38C solid !important;
            background-color: #FFF6F0;
            padding: 5px 0 10px 5px;
        }

        .showtpl1 label, .showtpl2 label {
            cursor: pointer;
        }

        .showtpl a:hover, .showindex a:hover {
        ...
        <div id="<?= MPS_SOFTNAME ?>">
            <table border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <?php foreach ($template['fengge']['flag'] as $k => $v) { ?>
                            <div id="index_<?= $k ?>"
                                 class="showtpl1 <?php if ($mymps_global['cfg_tpl_dir'] == $k) { ?>checked<?php } ?>">
                                <label for="<?= $k ?>">
                                    <div class="txt"><span class="<?= $k ?>"></span>
                                        <div class="clearfix"></div>
                                        <input onclick="$Obj('index_blue').className='showtpl1';$Obj('index_green').className='showtpl1';$Obj('index_orange').className='showtpl1';$Obj('index_red').className='showtpl1';$Obj('index_<?= $k ?>').className='showtpl1 checked';<?php if ($k == 'red') {
                                            echo '$Obj(\'style_normal\').disabled=true;$Obj(\'style_standard\').checked=true';
                                        } else {
                                            echo '$Obj(\'style_normal\').disabled=false;';
                                        } ?>" id="<?= $k ?>" name="cfg_tpl_dir" type="radio" class="radio"
                                               value="<?= $k ?>"
                                               <?php if ($mymps_global['cfg_tpl_dir'] == $k){ ?>checked="checked"<?php } ?>><?= $v ?>
                                        <br/><font color="#666">(<?= $k ?>)</font></div>
                                </label>
                            </div>
                        <?php } ?>
                    </td>
                ...
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <label for="bodybg_1"><input id="bodybg_1" name="bodybg" type="radio"
                                                     value="1" <?php if ($mymps_global['bodybg'] == '1') {
                                echo ' checked="checked" ';
                            } ?>> 是</label>
                        <label for="bodybg_0"><input id="bodybg_0" name="bodybg" type="radio" value="0"
                                                     <?php if ($mymps_global['bodybg'] == '0'){ ?>checked="checked"<?php } ?>>
                            否</label>
                    </td>
                </tr>
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <?php foreach ($template['banmian']['flag'] as $k => $v) {
                            ...
                            <div class="showtpl2">
                                <label for="<?= $k ?>"
                                       title="<?php echo $k == 'simple' ? '适合分类信息为主的站长使用' : ($k == 'portal' ? '适合地方门户的站长使用' : '适合其他行业信息的站长使用') ?>">
                                    <!--<div class="img"><img src="../images/tpl_preview/<?= $k ?>.gif"></div>-->
                                    <div id="banmian_<?= $k ?>" style="padding:15px;"
                                         class="txt <?php if ($tpl_index[banmian] == $k) { ?>checked<?php } ?>"><?= $v ?>
                                        <input <?php echo $obj; ?> id="<?= $k ?>" name="tpl_index[banmian]" type="radio"
                                                                   class="radio" value="<?= $k ?>"
                                                                   <?php if ($tpl_index[banmian] == $k){ ?>checked="checked"<?php } ?>><br/><font
                                                color="#666">模板文件路径<br/>/template/default/index_<font
                                                    style="color:#cd0000;"><?= $k ?></font>.html</font></div>
                                </label>
                            </div>
                        <?php } ?>
                        <div class="clear"></div>
                        <div id="simple_tpl"
                             style="display:<?php if ($tpl_index[banmian] != 'simple') { ?>none<?php } ?>;">
                                        ...
                                        <ul>
                                            ...
                                            <li class="rad">
                                                <select name="tpl_index[showstyle][<?= $v[catid] ?>]">
                                                    <option value="1" <?php if ($tpl_index[showstyle][$v[catid]] == 1) echo 'selected'; ?>>
                                                        单列
                                                    </option>
                                                    <option value="2" <?php if ($tpl_index[showstyle][$v[catid]] == 2) echo 'selected'; ?>>
                                                        双列
                                                    </option>
                                                    <option value="3" <?php if ($tpl_index[showstyle][$v[catid]] == 3) echo 'selected'; ?>>
                                                        三列
                                                    </option>
                                                </select>
                                            </li>
                        ...
                        <div id="classic_tpl"
                             style="display:<?php if ($tpl_index[banmian] != 'classic') { ?>none<?php } ?>;">
                            <div class="simple_tpl_bg">
                                <div class="bd">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>首页展示分类栏目至多数量</td>
                                            <td><input name="tpl_index[classic][cats]" type="txt" class="txt"
                                                       value="<?= $tpl_index[classic][cats] ?>"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                        ...
                        <div id="portal_tpl"
                             style="display:<?php if ($tpl_index[banmian] != 'portal') { ?>none<?php } ?>;">
                            <div class="simple_tpl_bg">
                                <div class="hd">板块ID指定（以适应自行修改过分类后，模板模块不对应）</div>
                                <div class="bd">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>当前 <span>二手转让</span>栏目ID（默认1）</td>
                                            <td><input name="tpl_index[portal][ershou]" type="txt" class="txt"
                                                       value="<?= $tpl_index[portal][ershou] ?>"></td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;模型ID（默认2）<input
                                                        name="tpl_index[portal][ershoumod]" type="txt" class="txt"
                                                        value="<?= $tpl_index[portal][ershoumod] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>当前 <span>出租房</span>栏目ID（默认41）</td>
                                            <td><input name="tpl_index[portal][zufang]" type="text" class="txt"
                                                       value="<?= $tpl_index[portal][zufang] ?>"></td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;模型ID（默认23）<input
                                                        name="tpl_index[portal][zufangmod]" type="txt" class="txt"
                                                        value="<?= $tpl_index[portal][zufangmod] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>当前 <span>二手房</span>栏目ID（默认43）</td>
                                            <td><input name="tpl_index[portal][ershoufang]" type="txt" class="txt"
                                                       value="<?= $tpl_index[portal][ershoufang] ?>"></td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;模型ID（默认22）<input
                                                        name="tpl_index[portal][ershoufangmod]" type="txt" class="txt"
                                                        value="<?= $tpl_index[portal][ershoufangmod] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>当前 <span>招聘</span>栏目ID（默认4）</td>
                                            <td><input name="tpl_index[portal][zhaopin]" type="text" class="txt"
                                                       value="<?= $tpl_index[portal][zhaopin] ?>"></td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;模型ID（默认7）<input
                                                        name="tpl_index[portal][zhaopinmod]" type="txt" class="txt"
                                                        value="<?= $tpl_index[portal][zhaopinmod] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>当前 <span>求职简历</span>栏目ID（默认6）</td>
                                            <td><input name="tpl_index[portal][jianli]" type="text" class="txt"
                                                       value="<?= $tpl_index[portal][jianli] ?>"></td>
                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;模型ID（默认9）<input
                                                        name="tpl_index[portal][jianlimod]" type="txt" class="txt"
                                                        value="<?= $tpl_index[portal][jianlimod] ?>"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                            ...
                            <div class="simple_tpl_bg" style="margin-top:5px;">
                                <div class="hd">各分类选项名（以适应自行修改过选项名后，首页模板选项值不显示 <a href="info_type.php?classid=2"
                                                                                  target="_blank">查看选项名</a>）
                                </div>
                                <div class="bd">
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td><span>二手房</span>面积选项名（默认acreage）</td>
                                            <td><input style="width:100px;" name="tpl_index[portali][acreage]"
                                                       type="txt" class="text"
                                                       value="<?= $tpl_index[portali][acreage] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td><span>二手房</span>房价选项名（默认prices）</td>
                                            <td><input style="width:100px;" name="tpl_index[portali][prices]" type="txt"
                                                       class="text" value="<?= $tpl_index[portali][prices] ?>"></td>
                                        </tr>
                                        <tr>
                                            <td><span>招聘</span>公司名选项名（默认company）</td>
                                            <td><input style="width:100px;" name="tpl_index[portali][company]"
                                                       type="txt" class="text"
                                                       value="<?= $tpl_index[portali][company] ?>"></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
                ...
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <input id="indextopinfo" name="tpl_index[indextopinfo]" value="<?= $tpl_index[indextopinfo] ?>"
                               type="text" class="txt">
                    </td>
                </tr>
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <input id="newinfo" name="tpl_index[newinfo]" value="<?= $tpl_index[newinfo] ?>" type="text"
                               class="txt">
                    </td>
                </tr>
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <input id="announce" name="tpl_index[announce]" value="<?= $tpl_index[announce] ?>" type="text"
                               class="txt">
                    </td>
                </tr>
                <tr bgcolor="white">
                ...
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <input id="foreachinfo" name="tpl_index[foreachinfo]" value="<?= $tpl_index[foreachinfo] ?>"
                               type="text" class="txt">
                    </td>
                </tr>
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <input id="goods" name="tpl_index[goods]" value="<?= $tpl_index[goods] ?>" type="text"
                               class="txt">
                    </td>
                </tr>
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <input id="telephone" name="tpl_index[telephone]" value="<?= $tpl_index[telephone] ?>"
                               type="text" class="txt">
                    </td>
                </tr>
                <tr bgcolor="white">
                    ...
                    <td class="altbg2">
                        <input id="lifebox" name="tpl_index[lifebox]" value="<?= $tpl_index[lifebox] ?>" type="text"
                               class="txt">
                    </td>
                </tr>
            </table>
