<?php include mymps_tpl('inc_head'); ?>
    ...
    <div id="<?= MPS_SOFTNAME ?>">
        <table border="0" cellspacing="0" cellpadding="0" class="vbm">
            ...
            foreach ($links AS $row) {
                ...
                <form action="friendlink_type.php" method="post" enctype="multipart/form-data" name="form2" ;>
                    ...
                    <tr bgcolor="#f5fbff" onMouseOver="this.className='Ipt IptIn'" onmouseout="this.className='Ipt'">
                        ...
                        <td valign="top"><input name="typename" value="<?= $row[typename] ?>" type="text"
                                                class="text' class='pubinputs' style=" width:90%" />
                        </td>
                        <td align="center">
                            <input type="submit" value="更 改" class="mymps mini"/>　<input type="button"
                                                                                         onClick="location.href='friendlink_type.php?part=delete&typeid=<?= $row[id] ?>'"
                                                                                         value="删 除"
                                                                                         class="mymps mini"/></td>
                    </tr>
                </form>
            ...
            <form action="friendlink_type.php" method="post" enctype="multipart/form-data" name="form1"
