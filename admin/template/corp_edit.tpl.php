        ...
        <div id="<?= MPS_SOFTNAME ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr bgcolor="#f5fbff">
                    <td>商家分类名称</td>
                    <td>
                        <input name="corpname" class="text" type="text" id="corpname" value="<?= $corp[corpname] ?>"
                               size="30">
                ...
                <tr bgcolor="#f5fbff">
                    <td>分类排序</td>
                    <td><input name="corporder" class="text" type="text" id="corporder" value="<?= $corp[corporder] ?>"
                               size="30"></td>
                </tr>
            </table>
        </div>
