                ...
                <ul class="clearfix tab-list">
                    <? if ($part == 'add') { ?>
                        ...
                        <li><a href="?part=add&if_corp=1"
                               <?php if ($if_corp == 1){ ?>class="current"<?php } ?>>增加商家会员</a></li>
                    <? } else { ?>
        ...
        <div id="<?= MPS_SOFTNAME ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <td><input name="userid" type="text" class="text"
                               value="<?= $edit[userid] ?>"/> <?php if ($edit) { ?>【非必要，请勿修改<font color="red"><b>特别是整合其他系统（如：ucenter）之后</b></font>】<?php } ?>
                    </td>
                </tr>
                <tr bgcolor="#ffffff">
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <td><input name="userpwd" type="text" class="text"/> <? if ($part == 'edit') { ?>【若不修改请留空】<? } ?>
                    </td>
                </tr>
                <tr class="firstr">
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <td>
                        <select name="per_certify">
                            <option value="1" <?php if ($edit['per_certify'] == 1) echo 'selected style="background-color:#6EB00C;color:white"'; ?>>
                                通过验证
                            </option>
                            <option value="0" <?php if (empty($edit['per_certify'])) echo 'selected style="background-color:#6EB00C;color:white"'; ?>>
                                未通过验证
                            </option>
                        </select></td>
                </tr>
                <tr bgcolor="#ffffff">
                    ...
                    <td><input name="money_own" type="text" class="txt" value="<?= $edit[money_own] ?>"/> <img
                                src="../member/images/mymps_icon_incomes.gif" align="absmiddle"></td>
                </tr>
                <tr bgcolor="#ffffff">
                    <td height="30">积分：</td>
