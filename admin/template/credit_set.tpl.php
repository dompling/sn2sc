<?php include mymps_tpl('inc_head'); ?>
    ...
    <div id="<?= MPS_SOFTNAME ?>" style="margin-top:10px;">
        <table border="0" cellspacing="0" cellpadding="0" class="vbm">
            ...
            <tr bgcolor="#ffffff">
                <td>
                    <li><input type="button" class="gray mini"
                               onclick="location.href='?ac=update_credits';this.disabled='true'" value="更新会员信用图标"></li>
                </td>
                <td>
                    <div style="color:#333">
        ...
        <div id="<?= MPS_SOFTNAME ?>">
            <table border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr align="center" bgcolor="white">
                    <td><?php echo $i; ?></td>
                    <td><input type="text" class="txt" name="credit_setnew[rank][<?php echo $i; ?>]"
                               value="<?php echo $credit_set[rank][$i] ?>"></td>
                    <td><?php echo $credit_set[rank][$i + 1] ?>&nbsp;</td>
                    <td><img src="../images/credit/<?php echo $i; ?>.gif" border="0"></td>
                    <?php } ?>
            </table>
        </div>
