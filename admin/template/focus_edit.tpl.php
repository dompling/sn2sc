<?php include mymps_tpl('inc_head'); ?>
    ...
    <form method="post" name="form1" action="focus.php?part=<?= $part ?>" enctype="multipart/form-data"
        ...
        <div id="<?= MPS_SOFTNAME ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr bgcolor="#f5fbff">
                    ...
                    <td>
                        <input name=image type=text class="text" style='background-color:#CCCCCC'
                               value="<?= $row[image] ?>" readonly="readonly"/> 不可更改
                    </td>
                </tr>
                <tr bgcolor="#f5fbff">
                    <td width="15%">原图片：</td>
                ...
                <tr bgcolor="#f5fbff">
                    ...
                    <td><input type="file" name="mymps_focus" size="45" id="litpic"><br/><br/>
                        ...
                        网站首页幻灯片尺寸：<?= $mymps_mymps[cfg_focus_limit][$tpl_index[banmian]][index][width] ?>
                        * <?= $mymps_mymps[cfg_focus_limit][$tpl_index[banmian]][index][height] ?><br/>
                        新闻首页幻灯片尺寸：<?= $mymps_mymps[cfg_focus_limit][news][width] ?>
                        * <?= $mymps_mymps[cfg_focus_limit][news][height] ?><br/>
                    </td>
                </tr>
                <tr bgcolor="#f5fbff">
                    <td width="15%">图片顺序：</td>
