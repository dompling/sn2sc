            ...
            <table border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <?php if ($paydetail[paytype] == 'alipay') { ?>
                    <tr bgcolor="#f5fbff">
                        ...
                        <td bgcolor="white">
                            <label for="r1"><input type="radio" name="buytype" value="1"
                                                   id="r1" <?php if ($paydetail[buytype] == 1) echo 'checked'; ?>>即时到帐收款</label>
                            <label for="r3"><input type="radio" name="buytype" value="3"
                                                   id="r3" <?php if ($paydetail[buytype] == 3) echo 'checked'; ?>>担保交易收款</label>
                            <label for="r2"><input type="radio" name="buytype" value="2"
                                                   id="r2" <?php if ($paydetail[buytype] == 2) echo 'checked'; ?>>双功能收款</label>
                        </td>
                    </tr>
                <?php } ?>
                <tr bgcolor="#f5fbff">
                ...
                <tr bgcolor="#f5fbff">
                    <td width="15%"
                        height="25"><?php if ($paydetail['paytype'] == 'alipay' || $paydetail['paytype'] == 'alipay_h5') { ?>参数二<? } elseif ($paydetail['paytype'] == 'wxpay') { ?>参数三<? } else { ?>参数一<?php } ?>
                        ：
                    </td>
                    <td bgcolor="white">
                ...
                <tr bgcolor="#f5fbff">
                    <td width="15%"
                        height="25"><?php if ($paydetail['paytype'] == 'alipay' || $paydetail['paytype'] == 'alipay_h5') { ?>参数三<? } elseif ($paydetail['paytype'] == 'wxpay') { ?>参数四<? } else { ?>参数二<?php } ?>
                        ：
                    </td>
                    <td bgcolor="white">
                ...
                <tr bgcolor="#f5fbff">
                    ...
                    <td bgcolor="white">
                        <label for="0"><input name="isclose" type="radio" value="0" class="radio"
                                              id="0" <?php if ($paydetail['isclose'] == '0') echo 'checked'; ?>/>开启</label>
                        <label for="1"><input name="isclose" type="radio" value="1" class="radio"
                                              id="1" <?php if ($paydetail['isclose'] == '1') echo 'checked'; ?>/>关闭</label>
                    </td>
                </tr>
                <tr bgcolor="#f5fbff">
