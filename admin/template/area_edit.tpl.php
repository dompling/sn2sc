        ...
        <div id="<?= MPS_SOFTNAME ?>">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr bgcolor="#f5fbff">
                    <td>地区名称</td>
                    <td>
                        <input name="areaname" class="text" type="text" id="areaname" value="<?= $area[areaname] ?>"
                               size="30">
                ...
                <tr bgcolor="#f5fbff">
                    <td>地区排序</td>
                    <td><input name="areaorder" class="text" type="text" id="areaorder" value="<?= $area[areaorder] ?>"
                               size="30"></td>
                </tr>
            </table>
        </div>
