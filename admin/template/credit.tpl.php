        ...
        <div id="<?= MPS_SOFTNAME ?>">
            <table border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr bgcolor="#f1f5f8">
                    ...
                    <td bgcolor="#ffffff"><input name="credit_new[rank][com_certify]"
                                                 value="<?php echo $credit[rank]['com_certify'] ?>" class="txt"/> <i>
                            初始值:<font color="red">+50</font></i></td>
                </tr>
                <tr bgcolor="#f1f5f8">
                    <td style="width:35%; line-height:22px">通过身份证认证，信用值变化</td>
                    <td bgcolor="#ffffff"><input name="credit_new[rank][per_certify]"
                                                 value="<?php echo $credit[rank]['per_certify'] ?>" class="txt"/> <i>
                            初始值:<font color="red">+50</font></i></td>
                </tr>
                <tr class="firstr">
                ...
                <tr bgcolor="#f1f5f8">
                    ...
                    <td bgcolor="#ffffff"><input name="credit_new[rank][coin_credit]"
                                                 value="<?php echo $credit[rank]['coin_credit'] ?>" class="txt"/> <i>
                            初始值:<font color="red">+10</font></i></td>
                </tr>
            </table>
        </div>
