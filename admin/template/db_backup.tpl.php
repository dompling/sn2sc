<?php include mymps_tpl('inc_head'); ?>
    ...
    <div id="<?= MPS_SOFTNAME ?>">
        <table border="0" cellspacing="0" cellpadding="0" class="vbm">
            ...
            <tr bgcolor="#ffffff">
                <td id="menu_tip">
                    <li style="color:#FF6600;">服务器备份目录为 <font
                                color="#006acd"><b><? echo $mymps_global[cfg_backup_dir] ?></b></font></li>
        ...
        <div id="<?= MPS_SOFTNAME ?>">
            <table border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <td>
                        <label for="mymps"><input id="mymps" name="type" type="radio" class="radio" value="mymps"
                                                  checked="checked" onClick="hide_backup_type()"> Mymps全部数据</label>
                    </td>
                </tr>
                <tr bgcolor="#ffffff">
                    <td width="56" class="bd_txt">&nbsp;</td>
                    <td>
                        <label for="isjump"><input name="type" type="radio" class="radio" value="custom" id="isjump"
                                                   onClick="hide_backup_type()"> 自定义备份</label>
                    </td>
                </tr>
                <tr bgcolor="#ffffff" id="redirecturltr" style="display:none">
                    <td>
                        <input class="checkbox" name="chkall" onclick="CheckAll(this.form)" checked="checked"
                               type="checkbox" id="chkalltables"/><label for="chkalltables"> 全选</label>
                    </td>
                    <td>
                        <ul class="dblist" onmouseover="altStyle(this);">
                            <?php foreach ($mymps_tables as $key => $val) { ?>
                                <li><label for="list_<?php echo $val['Name']; ?>"><input type="checkbox"
                                                                                         name="customtables[]"
                                                                                         value="<?php echo $val['Name']; ?>"
                                                                                         class="checkbox"
                                                                                         checked="checked"
                                                                                         id="list_<?php echo $val['Name']; ?>"/> <?php echo $val['Name']; ?>
                                    </label></li>
                            <?php } ?>
                        </ul>
                    </td>
                ...
                <tr bgcolor="#ffffff">
                    ...
                    <td>
                        ...
                        <input class="radio" type="radio" name="sqlcharset" value="utf8">&nbsp;UTF-8
                    </td>
                </tr>
                <tr bgcolor="#ffffff">
                    <td>十六进制方式</td>
                ...
                <tr bgcolor="#ffffff">
                    <td>备份文件名</td>
                    <td><input type="text" class="text" name="filename" value="<?php echo $defaultfilename; ?>"/>.sql
                    </td>
                </tr>
                <tr bgcolor="#ffffff">
                    <td>单卷文件长度限制</td>
