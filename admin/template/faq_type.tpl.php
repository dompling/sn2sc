            ...
            foreach ($links AS $row) {
                ...
                <form action="faq.php?do=type" method="post" name="form2" ;>
                    ...
                    <tr bgcolor="#f5fbff">
                        ...
                        <td valign="top"><input name="typename" value="<?= $row[typename] ?>" class="text" type="text"
                                                style="width:90%"/></td>
                        <td align="center">
                            <input type="submit" value="更 改" class="gray mini"/>　<input type="button"
                                                                                        onClick="location.href='faq.php?do=type&part=delete&id=<?= $row[id] ?>'"
                                                                                        value="删 除" class="gray mini"/>
                        </td>
                    </tr>
                </form>
                <?php
