            ...
            <table border="0" cellspacing="0" cellpadding="0" class="vbm">
                ...
                <tr>
                    ...
                    <td class="altbg2">
                        ...
                        <label for="smarty_caches"><input checked="checked" name="updatecache[]" value="tpl_caches"
                                                          type="checkbox" class="checkbox"
                                                          id="smarty_caches">清除网页缓存文件</label><br/>
                        <label for="smarty_compiles"><input checked="checked" name="updatecache[]" value="tpl_compiles"
                                                            type="checkbox" class="checkbox" id="smarty_compiles">清除模板编译文件</label><br/>
