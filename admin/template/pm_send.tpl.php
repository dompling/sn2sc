            ...
            <form name="form1" action="pm.php?" method="post" target='stafrm'>
                ...
                <tr bgcolor="#f5fbff">
                    ...
                    <td><select name="group[]" size="5" style="width:100px" multiple="multiple">
                            <?= member_groups() ?>
                        </select><br/><br/>若须发送短消息至指定会员，则不要选择会员组选项
                    </td>
                </tr>
                <tr bgcolor="#f5fbff">
                    <td width="80">指定会员：</td>
                    <td><input name="touser" style="width:300px" class="text" type="text" value="<?= $userid ?>"/>
                        多个会员用户名用 , 隔开
                    </td>
                </tr>
                <tr bgcolor="#f5fbff">
                ...
                <tr>
                    ...
                    <td bgcolor="#f5f8ff"><input name="pm_submit" style="margin:10px;" class="mymps large" type="submit"
                                                 value="提交发送"></td>
                </tr>
            </form>
